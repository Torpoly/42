...
//canon
Form::Form( void ) : _name( "A4" ) , _isSigned( false ), _gradeToSign( 1 ), _gradeToExecute( 150 ) {
...
Form & Form::operator=( const Form & toTheRight ) {
...
unsigned int	Form::_isGoodGrade( unsigned int gradeTo ) {
...
bool	Form::beSigned( const Bureaucrat & bureaucratTringToSign ) {
...
std::ostream & operator<<( std::ostream & o, Form const & toTheRight ) {
	...
	<< " Form with a grade to sign at " << toTheRight.getGradeToSign() << ", and grade to execute at "
